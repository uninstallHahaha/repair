    ...
    <div class="container_full">
        ...
        <div class="side_bar scroll_auto">
            ...
            <ul id="dc_accordion" class="sidebar-menu tree">
                ...
                <li class="menu_sub">
                    <a href="/WEB-INF/pages/table-record-manage.htmlrd-manage.html">
                            ...
                            <div class="breadcrumb_nav">
                                <ol class="breadcrumb">
                                    <li>
                                        ...
                                        <a class="parent-item" href="../../index.html">报修受理</a>
...
<script src="/xgather/xjs/table-record-deal.js"></script>
</body>
