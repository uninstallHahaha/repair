                            ...
                            <div class="breadcrumb_nav">
                                <ol class="breadcrumb">
                                    <li>
                                        ...
                                        <a class="parent-item" href="../../index.html">维修人员管理</a>
                            ...
                            <div class="card-header">
                                <div class="card-title">
                                    ...
                                    <button style="float: right;" type="button"
                                        ...
                                        <i class=" icon-plus pr-2"></i>添加维修人员
                                    </button>
                                </div>
                            </div>
                            <div class="card-body">

                                <c:forEach items="${workers}" var="u">
                                    <div class="media mb-4" userid="${u.id}">
                                        ...
                                        <div class="media-body">
                                            ...
                                            <span>所属部门: ${u.department == 1?'物业部门':'工程部门'}</span>&nbsp;
                                            <span>待完成任务数:${u.todo} &emsp;&emsp; 已完成任务数:${u.finish}</span>
                                            <button style="float: right;" type="button"
                                                    onclick="delUser('${u.id}')"
                                                    class="btn btn-square  btn-outline-danger" title="删除">
